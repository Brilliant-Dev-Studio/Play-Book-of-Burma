...
import jasonHeadshot from "@/app/assets/home/Ko Jason Myint.png";
...
const YOUR_NOTES: NoteItem[] = Array.from({ length: 4 }, () => ({
  image: jasonHeadshot,
  title: "Financial Management",
  author: "Ko Jason Myint",
}));

const YOUR_BOOKMARKS: ContinuesWatchingItem[] = Array.from({ length: 6 }, () => ({
  image: courseThumb,
  duration: "16:36",
  progressPct: 35,
  author: "Ko Jason Myint",
...
function NoteCard({ image, title, author }: NoteItem) {
  return (
    <article className="flex min-h-72 flex-col bg-zinc-900/70 px-3 py-6 ring-1 ring-white/10 sm:min-h-80 sm:px-4 sm:py-8">
      <div className="mx-auto mt-3 h-20 w-20 overflow-hidden rounded-md bg-zinc-800 sm:mt-5">
        <Image
          src={image}
          alt=""
          width={80}
