...
export const membershipFormFieldErrorClass =
  "w-full rounded-xl border border-red-500/50 bg-zinc-950/55 px-4 py-3 text-base leading-snug text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] outline-none transition-[border-color,box-shadow,background-color] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] placeholder:text-white/38 hover:border-red-500/60 hover:bg-zinc-950/70 focus:border-red-500/70 focus:bg-zinc-950/80 focus:shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_0_0_3px_rgba(239,68,68,0.2)]";
